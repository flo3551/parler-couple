---
title: "Méthode CNV couple : les 4 étapes OSBD pour arrêter de se blesser"
metaDescription: "Découvrez la méthode CNV appliquée au couple avec des exemples concrets. Transformez vos disputes grâce aux 4 étapes OSBD : Observation, Sentiment, Besoin, Demande."
kw_primary: "méthode CNV couple"
kw_secondary: ["communication non-violente couple", "CNV relation amoureuse", "apprendre CNV en couple"]
internal_links:
  - url: "/communication-non-violente-couple"
    anchor: "principes de la communication non-violente"
  - url: "/exercices-cnv-couple"
    anchor: "exercices CNV pratiques pour couples"
  - url: "/guide-communication-couple-pdf"
    anchor: "télécharger le guide CNV complet"
  - url: "/shop/cartes-conversation-couple"
    anchor: "cartes CNV pour pratiquer ensemble"
word_count: 2200
pubDate: 2026-04-03
draft: false
...
## L'OSBD : un cadre en 4 étapes, pas une formule magique

OSBD. Quatre lettres pour Observation, Sentiment, Besoin, Demande. C'est la colonne vertébrale de la CNV.
...
Le problème, c'est qu'on n'a souvent pas appris à nommer ses besoins. Alors on les exprime sous forme de reproches : "Tu ne penses jamais à moi" cache souvent un besoin de connexion ou d'attention. "Tu fais toujours à ta façon" cache un besoin d'être inclus dans les décisions.
...
Une bonne demande en CNV est :
- **Concrète** : "Est-ce que tu peux me prévenir par message quand tu seras en retard ?"
...
Voici un exemple tiré d'un quotidien de couple classique.

**La situation** : Léa avait demandé à Thomas de s'occuper des courses le samedi. Thomas a oublié. Léa rentre et il n'y a rien à manger.

**Version classique :**

> Léa : "C'est incroyable. Tu oublies tout, comme d'habitude. Je peux vraiment compter sur toi ?"
>
> Thomas : "J'ai eu une journée de dingue. C'est ça, merci pour ta confiance."
>
> Léa : "Moi aussi j'ai eu une journée de dingue, mais moi je m'en souviens quand même."

Résultat : une heure de silence, des reproches qui s'accumulent, personne qui a mangé correctement et un fond de rancœur pour le week-end.

**Version CNV :**

> Léa : "Les courses n'ont pas été faites (observation). Je suis déçue et franchement un peu épuisée (sentiment). J'ai besoin qu'on puisse s'appuyer l'un sur l'autre pour les tâches du quotidien, surtout en semaine chargée (besoin). Est-ce qu'on peut trouver un système ensemble pour que ça ne se reproduise pas ? (demande)"
>
> Thomas : "Tu as raison, j'ai complètement oublié. Je m'en excuse vraiment. Qu'est-ce que tu proposes ?"

Ce n'est pas de la magie. C'est une façon différente d'entrer dans la conversation. Léa n'attaque pas Thomas. Thomas n'a pas à se défendre. Le problème peut être résolu.

## Les erreurs les plus fréquentes quand on commence la CNV
...
## Comment commencer à deux

La CNV se pratique seul, mais elle prend tout son sens à deux. Quelques façons de commencer sans que ça devienne un cours magistral :
...
## Ce que la CNV change réellement dans une relation
